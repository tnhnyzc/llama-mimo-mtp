...
The Metal MTP run accepted draft tokens on those prompts, with observed acceptance around `78-86%`, but this small short-prompt benchmark is not a Metal speedup claim.
